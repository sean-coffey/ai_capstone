...
def update_train_log(country,date_range, eval_test, runtime, MODEL_VERSION, MODEL_VERSION_NOTE, test=False):
    """
    ...
    header = ['unique_id','timestamp','country','date_range','eval_test','model_version',
    ...
    with open(logfile, 'a') as csvfile:
        ...
        to_write = map(str, [uuid.uuid4(), time.time(), country, date_range,eval_test,
